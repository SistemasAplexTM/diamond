    ...
    <table cellspacing="0" cellpadding="0" id="tableContainer" border="0" width="100%" style="margin-top: 20px;">
        <thead>
            ...
            <tr>
                ...
                <th>
                    <div id="t_detalle" style="text-align: center;">VOLUME</div>
                </th>
                {{-- <th><div id="t_detalle" style="text-align: center;">FOB</div></th> --}}
            </tr>
            <tr>
                <th colspan="7" style="margin-bottom:10px;font-size:3px;background-color: #ccc">&nbsp;</th>
            </tr>
        </thead>
        <tbody>
            <?php
        ...
        ?>
            ...
            <tr>
                ...
                {{-- <td id="detalle" style="text-align: center;">
                        @if($val->declarado2 == 0)
                           <div style="background-color:black;color:white;">$ {{ number_format($val->declarado2,2) }}
                <div>
                    @else
        ...
        <tfoot>
            <tr>
                ...
                <th>
                    <div style="margin-top:5px;text-align: center;font-size: 14px;color:#1d1d1e;">{{ ceil($vol) }} Lb
                    </div>
                </th>
            </tr>
            <tr>
