...
<head>
  <title>Manifiesto Guias {{ $documento->consecutivo }}</title>
</head>
                    ...
                    <tr>
                      ...
                      <td>
                        <div id="shipper">
                          ...
                          , {{ ($value->ship_zip2) ? $value->ship_zip2 : $value->ship_zip }}
                        </div>
                      </td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      ...
                      <td>
                        <div id="consignee">
                          ...
                          {{ ($value->cons_zip2) ? $value->cons_zip2 : $value->cons_zip }}
                        </div>
                      </td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td width="35%" style="text-align: center;">
                        <div style="color: #1d1d1e;">
                          {{ '$ '.number_format($value->declarado2, 2) }}
                        </div>
