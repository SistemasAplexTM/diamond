...
@section('content')
    <div class="row" id="empleado">
        <form id="formempleados" enctype="multipart/form-data" class="form-horizontal" role="form">
            <div class="col-lg-4">
              ...
              <div class="ibox float-e-margins">
                  ...
                  <div class="ibox-content">
                      ...
                      <div class="table-responsive">
                          <table id="tbl-empleado" class="table table-striped table-hover table-bordered" style="width: 100%;">
                              <thead>
                                  <tr>
                                      <th>Documento</th>
                                      <th>Nombre</th>
...
@section('scripts')
<script src="{{ asset('js/templates/empleado.js') }}"></script>
@endsection
