                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-content gray-bg">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="control-label" for="codigo"
                                                    style="font-weight: 900;">@lang('general.warehouse_guide_tracking')</label>
                                                <div class="input-group" :class="{ 'has-error': errors.has('codigo') }">
                                                    <input type="text"
                                                        placeholder="@lang('general.track_your_package_here')"
                                                        class="form-control" name="codigo" v-model="codigo"
                                                        v-validate.disabled="'required'">
                                                    <span class="input-group-btn">
                                                        <button @click.prevent="getData()" type="button"
                                                            class="ladda-button btn btn-primary"
                                                            data-style="expand-right" title=""><span
                                                                class="ladda-label"> Rastrear <i
                                                                    class="fal fa-map-marker"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>@lang('general.weight'): <span id="peso_label">@{{ peso_label }}
                                                        Lbs</span></label>
                                                <div>@lang('general.deliver_date'): <span
                                                        id="fecha_label">@{{ fecha_entrega }}</span></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>@lang('general.tracking'): </label>
                                                <div class="" id="tracking_label" v-for="tracking in tracking_label">-
                                                    @{{ tracking }}</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row" v-for="dato in datos">
                                                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                            <h1 style="" class="day" id="estado_day1">
                                                                @{{ dato.day_data }}</h1>
                                                            <h2 style="" class="mont" id="estado_mont1">
                                                                @{{ dato.mont_data }}</h2>
                                                            <span class="year">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"
                                                            ...
                                                            <div style="text-align: center;">
                                                                ...
                                                                <i :class="dato.img"
                                                                    v-bind:style="{ color: dato.color }"></i>
                                                            </div>
                                                            <div style="padding: 15px 0px;"></div>
                                                            <div style="text-align: center;"><img id="estado_linea1"
                                                                    src="{{ asset('img/imagesRastreo/linea_puntos.png') }}">
                                                            </div>
                                                            <div style="padding: 15px 0px;"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
                                                    <h3 style="font-weight: 900;" id="estado_estado1">@{{ dato.estado }}
                                                    </h3>
                                                    <span style="font-weight: 300;" id="estado_descripcion1"
                                                        class="texto">@{{ dato.descripcion }}</span><br>
                                                    <span style="font-weight: 900;color: black;" id="estado_procedente1"
                                                        v-if="dato.status_id === 2">@{{ dato.procedencia }}</span>
                                                    <template v-if="dato.status_id === 12">
                                                        <span style="font-weight: 900;color: black;"
                                                            id="estado_procedente1">@{{ dato.transportadora }}</span><br>
                                                        <span style="font-weight: 300;" id="estado_descripcion1"
                                                            class="texto">Rastrear Guía: </span>
                                                        <span style="font-weight: 900;color: black;"
                                                            id="estado_procedente1" title="Rastreame"
                                                            data-toggle="tooltip" data-placement="right"><a
                                                                :href="dato.transportadora_url_rastreo + dato.transportadora_guia"
                                                                target="_blank">@{{ dato.transportadora_guia }} <i
                                                                    class="fal fa-map-marker-smile"></i></a></span>
