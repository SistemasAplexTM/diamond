      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">
            <i class="fal fa-users"></i> Registrar contactos
          </h4>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-4" v-for="campo in campos" :key="campo.id">
...
export default {
  ...
  methods: {
    ...
    get() {
      var me = this;
      axios
        .get("obtener_contactos/" + this.parametro + "/" + this.table)
    ...
    store() {
      var me = this;
      axios
        .post("agregar_contactos/" + this.parametro + "/" + this.table, {
          campos: me.campos
        })
        .then(function(response) {
